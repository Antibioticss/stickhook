...
struct stick_entry {
    const char *image_name; /* image file name, used for static patching and dynamic hooking */
...
#define stick_hook(_image_name, _vmaddr, _replacement, _originptr)                                                                                   \
    do {                                                                                                                                             \
        __attribute__((used, section("__TEXT,__text"))) static const unsigned char orig_stub[STICK_ORIGSIZE] = {0};                                  \
